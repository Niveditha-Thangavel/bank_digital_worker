import { CustomerAccount } from '../types/banking';
...
export const customerAccounts: CustomerAccount[] = [
  ...
  {
    customer_id: "C102",
    account_creation_date: "2025-07-01",
    credit_cards: [
      {
...
export function getCustomerAccount(customerId: string): CustomerAccount | undefined {
  return customerAccounts.find(account => account.customer_id === customerId);
}

export function getAllCustomerAccounts(): CustomerAccount[] {
