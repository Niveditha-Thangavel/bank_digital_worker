...
import { User, Bell, Shield, Moon, Sun, Monitor, Check } from 'lucide-react';
      ...
      <div className="flex-1 overflow-y-auto p-6 scrollbar-thin space-y-6">
        ...
        <section>
          ...
          <Card className="divide-y divide-border">
            ...
            <div className="p-4 flex items-center justify-between">
              <div>
                <p className="font-medium text-foreground">Decision Alerts</p>
                <p className="text-sm text-muted-foreground">Get notified about loan decisions</p>
              </div>
              <Switch
                checked={notifications.decisions}
                onCheckedChange={(checked) => setNotifications({ ...notifications, decisions: checked })}
              />
            </div>
          </Card>
        </section>
